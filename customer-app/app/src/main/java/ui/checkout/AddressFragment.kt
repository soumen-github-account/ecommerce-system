...
class AddressFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        btnDeliverHere.setOnClickListener {
            ...
            btnDeliverHere.isEnabled = false
            addressLoader.visibility = View.VISIBLE
    ...
    private fun loadUserAddresses() {
        ...
        lifecycleScope.launch {
            ...
            try {
                ...
                val response =
                    RetrofitClient.userApi.getUserAddresses("Bearer $token")
                ...
                if (response.isSuccessful && response.body() != null) {
                    ...
                    rvCheckoutAddresses.adapter =
                        CheckoutAddressAdapter(addresses) { selectedAddress ->

                            (activity as? CheckoutActivity)
                                ?.selectedAddressForCheckout = selectedAddress
                        }
